...
function generate_score(report) {
...
function parse_evaluation(evaluation) {
  try {
    ...
    report.data.tot.info.lang = get_html_lang(evaluation.report.system.page.dom.processed.html.plain);
    ...
    report.data.score = generate_score(report);
