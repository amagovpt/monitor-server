...
export { SELECTORS, CONFORMANCE_OUTPUT, DATE, TARGET_SELECTOR, SEAL, EVIDENCE, PROCEDURE, AUTOMATIC, MANUAL, USER, CONTACTS, PLENAMENTE_CONFORME, PARCIALMENTE_CONFORME, NAO_CONFORME}
