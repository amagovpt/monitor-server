...
function parseEvaluation(evaluation: any): any {
  ...
  report['data'].rawUrl = evaluation.report.system.url.completeUrl; //evaluation.earlReport.graph[0].source;
  ...
  report['data'].tot.info.tests = Object.keys(results).length; //evaluation.earlReport.graph[0].assertions.length;
